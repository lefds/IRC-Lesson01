...
int main(int argc, char* argv[])
{
	...
	setlocale(LC_ALL, ""); //se o OS tiver programado para a localização PT é automático ... de outra forma a língua deve ser definida explicitamente "Portuguese"
	SetConsoleCP(1252); SetConsoleOutputCP(1252);
	printf("Olá, sou o servidor!\n");
	...
	while (1) {
		...
		nbytes = recvfrom(sockfd, buffer, sizeof(buffer)-1, 0, NULL, NULL);
